...
namespace Program
{
    public static class ABC146A
    {
        ...
        static public void Solve()
        {
            ...
            else if (S == "MON") Console.WriteLine(6);
            else if (S == "TUE") Console.WriteLine(5);
            else if (S == "WED") Console.WriteLine(4);
            else if (S == "THU") Console.WriteLine(3);
            else if (S == "FRI") Console.WriteLine(2);
