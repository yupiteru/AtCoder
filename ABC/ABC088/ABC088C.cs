...
namespace Program
{
    public static class ABC088C
    {
        static public void Solve()
        {
            var grid = new long[3, 3];
            for (var i = 0; i < 3; i++)
            {
                for (var j = 0; j < 3; j++)
                {
            ...
            if (grid[0, 0] - grid[1, 0] == grid[0, 1] - grid[1, 1] && grid[0, 1] - grid[1, 1] == grid[0, 2] - grid[1, 2] &&
                grid[0, 0] - grid[2, 0] == grid[0, 1] - grid[2, 1] && grid[0, 1] - grid[2, 1] == grid[0, 2] - grid[2, 2] &&
                grid[1, 0] - grid[2, 0] == grid[1, 1] - grid[2, 1] && grid[1, 1] - grid[2, 1] == grid[1, 2] - grid[2, 2])
            {
