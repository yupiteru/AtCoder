...
namespace Program
{
    public static class ABC079A
    {
        ...
        {
            var N = NN;
            var ct = N.ToString().GroupBy(e => e);
            if (N.ToString()[0] != N.ToString()[3] && ct.Any(e => e.Count() == 3))
            {
                Console.WriteLine("Yes");
            }
            else if (N.ToString()[0] == N.ToString()[3] && ct.Any(e => e.Count() == 4))
            {
                Console.WriteLine("Yes");
            }
            else
