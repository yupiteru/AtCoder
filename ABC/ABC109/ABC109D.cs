    ...
    public static class ABC109D
    {
        static public void Solve()
        {
            ...
            for (int i = 0; i < H - 1; i++)
            {
                ...
                {
                    field[i + 1, W - 1]++;
                    opeList.Add((i + 1) + " " + W + " " + (i + 2) + " " + W);
                }
            }
            Console.WriteLine(opeList.Count);
            opeList.ForEach(Console.WriteLine);
        }
