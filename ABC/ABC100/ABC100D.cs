...
namespace Program
{
    public static class ABC100D
    {
        static public void Solve()
        {
            var N = NN;
            var M = NN;
            var xyz = Repeat(0, N).Select(_ => Tuple.Create(NN, NN, NN)).ToArray();

            Func<Tuple<long, long, long>, long> score = x => Abs(x.Item1) + Abs(x.Item2) + Abs(x.Item3);
            var a1 = score(xyz.OrderByRand().OrderBy(e => e.Item1 + e.Item2 + e.Item3).Take((int)M).Aggregate(Tuple.Create(0L, 0L, 0L), (a, x) => Tuple.Create(a.Item1 + x.Item1, a.Item2 + x.Item2, a.Item3 + x.Item3)));
            var a2 = score(xyz.OrderByRand().OrderBy(e => e.Item1 + e.Item2 - e.Item3).Take((int)M).Aggregate(Tuple.Create(0L, 0L, 0L), (a, x) => Tuple.Create(a.Item1 + x.Item1, a.Item2 + x.Item2, a.Item3 + x.Item3)));
            var a3 = score(xyz.OrderByRand().OrderBy(e => e.Item1 - e.Item2 + e.Item3).Take((int)M).Aggregate(Tuple.Create(0L, 0L, 0L), (a, x) => Tuple.Create(a.Item1 + x.Item1, a.Item2 + x.Item2, a.Item3 + x.Item3)));
            var a4 = score(xyz.OrderByRand().OrderBy(e => e.Item1 - e.Item2 - e.Item3).Take((int)M).Aggregate(Tuple.Create(0L, 0L, 0L), (a, x) => Tuple.Create(a.Item1 + x.Item1, a.Item2 + x.Item2, a.Item3 + x.Item3)));
            var a5 = score(xyz.OrderByRand().OrderBy(e => -e.Item1 + e.Item2 + e.Item3).Take((int)M).Aggregate(Tuple.Create(0L, 0L, 0L), (a, x) => Tuple.Create(a.Item1 + x.Item1, a.Item2 + x.Item2, a.Item3 + x.Item3)));
            var a6 = score(xyz.OrderByRand().OrderBy(e => -e.Item1 + e.Item2 - e.Item3).Take((int)M).Aggregate(Tuple.Create(0L, 0L, 0L), (a, x) => Tuple.Create(a.Item1 + x.Item1, a.Item2 + x.Item2, a.Item3 + x.Item3)));
            var a7 = score(xyz.OrderByRand().OrderBy(e => -e.Item1 - e.Item2 + e.Item3).Take((int)M).Aggregate(Tuple.Create(0L, 0L, 0L), (a, x) => Tuple.Create(a.Item1 + x.Item1, a.Item2 + x.Item2, a.Item3 + x.Item3)));
            var a8 = score(xyz.OrderByRand().OrderBy(e => -e.Item1 - e.Item2 - e.Item3).Take((int)M).Aggregate(Tuple.Create(0L, 0L, 0L), (a, x) => Tuple.Create(a.Item1 + x.Item1, a.Item2 + x.Item2, a.Item3 + x.Item3)));
            var ary = new[] { a1, a2, a3, a4, a5, a6, a7, a8 };
