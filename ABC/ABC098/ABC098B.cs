    ...
    public static class ABC098B
    {
        static public void Solve()
        {
            ...
            for (var i = 1; i < N; i++)
            {
                ...
                var str2 = S.Substring(i);
                var dic1 = new HashSet<char>();
                var dic2 = new HashSet<char>();
                str1.ToList().ForEach(e => dic1.Add(e));
                str2.ToList().ForEach(e => dic2.Add(e));
                var tmp = dic1.Where(e => dic2.Contains(e)).Count();
                max = Max(max, tmp);
            }
