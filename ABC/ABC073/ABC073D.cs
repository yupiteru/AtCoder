...
namespace Program
{
    public static class ABC073D
    {
        ...
        static public void Solve()
        {
            ...
            var M = NN;
            var R = NN;
            var rList = NNList(R).Select(e => e - 1).ToArray();
            ...
            Console.WriteLine(MinCost(-1, rList, graph.WarshallFloyd()));
        }
        public static long MinCost(long first, long[] tgt, long[,] dist)
        {
