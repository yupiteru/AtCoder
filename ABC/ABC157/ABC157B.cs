...
namespace Program
{
    public static class ABC157B
    {
        ...
        static public void Solve()
        {
            ...
            var N = NN;
            var bList = NNList(N);
            var ACList1 = AList1.Select(e => bList.Contains(e)).ToArray();
            var ACList2 = AList2.Select(e => bList.Contains(e)).ToArray();
            var ACList3 = AList3.Select(e => bList.Contains(e)).ToArray();
            var ok = false;
            ok |= ACList1.All(e => e);
            ok |= ACList2.All(e => e);
            ok |= ACList3.All(e => e);
            ok |= ACList1[0] && ACList2[0] && ACList3[0];
            ok |= ACList1[1] && ACList2[1] && ACList3[1];
            ok |= ACList1[2] && ACList2[2] && ACList3[2];
            ok |= ACList1[0] && ACList2[1] && ACList3[2];
            ok |= ACList1[2] && ACList2[1] && ACList3[0];
