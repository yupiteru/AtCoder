                ...
                for (int i3 = 0; i3 < 4; ++i3)
                {
                    for (int i2 = 0; i2 < 4; ++i2)
                    {
                        for (int i1 = 0; i1 < 4; ++i1)
                        {
                            for (int a = 0; a < 4; ++a)
                            {
                                if (i2 == 0 && i1 == 2 && a == 1) continue;
                                if (i2 == 2 && i1 == 0 && a == 1) continue;
                                if (i2 == 0 && i1 == 1 && a == 2) continue;
                                if (i3 == 0 && i2 == 2 && a == 1) continue;
                                if (i3 == 0 && i1 == 2 && a == 1) continue;

                                dp[i + 1][i2][i1][a] = Mod.Add(dp[i + 1][i2][i1][a], dp[i][i3][i2][i1]);
                            }
                        }
                    }
                }
