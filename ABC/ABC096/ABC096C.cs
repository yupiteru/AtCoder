...
namespace Program
{
    public static class ABC096C
    {
        static public void Solve()
        {
            ...
            {
                if (sList[x][y] == '.') return false;
                if (x != 0 && sList[x - 1][y] == '#') return false;
                if (y != 0 && sList[x][y - 1] == '#') return false;
                if (x != H - 1 && sList[x + 1][y] == '#') return false;
                if (y != W - 1 && sList[x][y + 1] == '#') return false;
                return true;
            };
