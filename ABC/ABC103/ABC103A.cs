...
namespace Program
{
    public static class ABC103A
    {
        static public void Solve()
        {
            var Alist = NNList(3);
            var diff1 = Abs(Alist[0] - Alist[1]);
            var diff2 = Abs(Alist[1] - Alist[2]);
            var diff3 = Abs(Alist[0] - Alist[2]);
            var ary = new[] { diff1, diff2, diff3 };
            Console.WriteLine(ary.OrderByDescending(e => e).Skip(1).Sum());
