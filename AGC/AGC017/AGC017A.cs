...
namespace Program
{
    public static class AGC017A
    {
        ...
        static public void Solve()
        {
            ...
            var ans = 0L;
            var ki = 0L;
            var kiCount = AList.Count(e => e % 2 == 1);
            var guCount = AList.Count(e => e % 2 == 0);
            if (kiCount == 0)
            {
                if (P == 1)
                {
                ...
                {
                    Console.WriteLine((long)(Math.Pow(2, N) + 0.3) );
                }
                return;
            }
            ki = (long)(Math.Pow(2, N - 1) + 0.3);
            ans = ki;
            if (P == 1)
            {
            ...
            {
                Console.WriteLine((long)(Math.Pow(2, N) + 0.3) - ans);
            }
        }
