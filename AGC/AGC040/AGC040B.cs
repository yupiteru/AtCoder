...
namespace Program
{
    public static class AGC040B
    {
        ...
        static public void Solve()
        {
            ...
            var lrListHenka = lrList.Select(e => new { e.R, e.L, len = e.R - e.L + 1 }).OrderByRand().OrderByDescending(e => e.len).ToList();
            var maxValue = lrListHenka.First().len + Max(0, lrListHenka.Skip(1).Min(e => e.R) - lrListHenka.Skip(1).Max(e => e.L) + 1);
