...
namespace Program
{
    public static class SUMITRUST2019B
    {
        ...
        {
            var N = NN;
            var kouho = (long)(N / 1.08);
            if ((long)(kouho * 1.08) == N)
            {
                Console.WriteLine(kouho);
            }
            else if ((long)((kouho - 1) * 1.08) == N)
            {
                Console.WriteLine(kouho - 1);
            }
            else if ((long)((kouho + 1) * 1.08) == N)
            {
                Console.WriteLine(kouho + 1);
