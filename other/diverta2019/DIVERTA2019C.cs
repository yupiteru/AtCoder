    ...
    public class DIVERTA2019C
    {
        static public void Main(string[] args)
        {
            ...
            for (int i = 0; i < N; ++i)
            {
                ...
                var lastA = s[i].Last() == 'A';
                var firstB = s[i].First() == 'B';
                if (lastA && firstB)
                {
                    ++lastAfirstBCount;
                }
            ...
            if (lastAfirstBCount > 0)
            {
                ...
                Console.WriteLine(fixABCount + lastAfirstBCount - 1 + Math.Min(lastACount, firstBCount));
            }
            else
            {
                Console.WriteLine(fixABCount + Math.Min(lastACount, firstBCount));
            }
        }
